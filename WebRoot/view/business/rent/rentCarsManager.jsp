	...
	<script type="text/javascript">
	    ...
	    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
			...
			function initCarData(){
				//渲染数据表格
				 tableIns=table.render({
				    ...
				    ,url:'${rincar}/car/loadAllCar.action?isrenting=0' //数据接口
				    ,title: '车辆据表'//数据导出来的标题
				    ,height:'full-220'
				    ...
				    ,cols: [[   //列表数据
				      ...
				      ,{field:'carimg', title:'缩略图',align:'center',width:'180',templet:function(d){
				    	  return "<img width=40 height=40 src=${rincar}/file/downloadShowFile.action?path="+d.carimg+" />";
				      }}
			...
			$("#doSearch").click(function(){
				...
				$.post("${rincar}/rent/checkCustomerExist.action",params,function(obj){
					if(obj.code>=0){
						$("#content").show();
						initCarData();
					}else{
