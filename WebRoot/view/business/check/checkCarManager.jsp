		...
		layui.use([ 'jquery', 'layer', 'form', 'table', 'laydate' ],
				function() {
					...
					$("#doSearch").click(function() {
						...
						$.post("${rincar}/check/checkRentExist.action", {
							rentid : rentid
						}, function(obj) {
							if (obj === "") {
					...
					function initCheckFormData(rentid){
						$.post("${rincar}/check/initCheckFormData.action",{rentid:rentid},function(obj){
							//检查单
							var check=obj.check;
							...
							$("#car_carimg").attr("src","${rincar}/file/downloadShowFile.action?path="+car.carimg);
						})
					}
					...
					form.on("submit(doSubmit)",function(){
						...
						$.post("${rincar}/check/saveCheck.action",params,function(obj){
							layer.msg(obj.msg);
							$("#content").hide();
						})
						return false;
