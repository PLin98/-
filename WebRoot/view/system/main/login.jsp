...
<head>
	...
	<link rel="icon" href="${rincar}/resources/favicon.ico">
...
<canvas id="canvas"></canvas>
	<form class="layui-form" id="loginFrm" method="post" action="${rincar }/login/login.action">
		<div class="login_face"><img src="${rincar}/resources/images/face.jpg" class="userAvatar"></div>
		...
		<div class="layui-form-item input-item" id="imgCode">
			...
			<img src="${rincar}/login/getCode.action" onclick="this.src=this.src+'?'">
		</div>
