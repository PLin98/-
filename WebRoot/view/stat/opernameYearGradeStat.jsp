...
<!-- 搜索条件开始 -->
	...
	<!-- 搜索条件结束 -->
       ...
       <script type="text/javascript" src="${rincar }/resources/echarts/js/echarts.min.js"></script>
       <script type="text/javascript" src="${rincar }/resources/echarts/js/jquery-3.1.1.min.js"></script>
       ...
       layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
		    ...
		    function getData(){
				...
				$.get("${rincar}/stat/loadOpernameYearGradeStat.action",{year:year},function(data){
