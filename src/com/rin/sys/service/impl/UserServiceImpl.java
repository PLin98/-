...
import com.rin.sys.domain.Role;
import com.rin.sys.domain.User;
import com.rin.sys.mapper.RoleMapper;
import com.rin.sys.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
	...
	//检查旧密码
	@Override
	public User getOldPwd(Integer userid, String oldPwd) {
		return this.userMapper.getOldPwd(userid,oldPwd);
	...
	@Override
	public int changePwd(Integer userid, String oldPwd, String confirmPwd) {
		// TODO Auto-generated method stub
		return this.userMapper.changePwd(userid,oldPwd,confirmPwd);
	}


	@Override
	public int changeUser(Integer userid,String realname, Integer usersex, String phone, String province) {
		// TODO Auto-generated method stub
		return this.userMapper.changeUser(userid,realname,usersex,phone,province);
	}
